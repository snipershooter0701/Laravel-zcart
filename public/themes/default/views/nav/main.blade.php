  ...
  <div class="container">
    <div class="header__top-inner">
      <div class="header__top-welcome">
        ...
        @else
          <h3>{{trans('theme.welcome').'Heavens9 Sports Nutrition'}}</h3>
<!--//.config('app_name')-->
        @endif
      </div>
  ...
  <div class="container">
    <div class="header__navigation-inner">
      ...
      <ul class="header__menu">
        ...
        <!--      <i class="fal fa-crown menu-icon"></i> {{trans('theme.sports_nutrition')}}-->
        <!--    </a>-->
        <!--</li>-->

        <li>
            <a class="menu-link" href="{{ route('brands') }}">
              <i class="fal fa-crown menu-icon"></i> {{trans('theme.vitamins_herbs')}}
            </a>
        </li>
        <li>
            <a class="menu-link" href="{{ route('brands') }}">
        ...
        <li>
          <a class="menu-link" href="{{ route('shops') }}">
              <i class="fal fa-store menu-icon"></i> {{trans('theme.sports_accessories')}}
          </a>
        </li>

        <li>
          <a class="menu-link" href="{{ url('/selling') }}">
            <i class="fal fa-seedling menu-icon"></i> {{ trans('theme.nav.contact_us') }}
          </a>
        </li>
