                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-4  col-sm-6 col-6">
                            <div class="footer__content-box">
                                <div class="footer__content-box-inner">
                                    <div class="footer__content-box-title">
                                        <h3>@lang('theme.nav.join_in_our_team')</h3>
                                    </div>
                                    <div class="footer__content-box-links">
                                        <ul>
                                            <!-- <li>
                                            ...
                                            <li>
                                                ...
                                                @lang('theme.nav.partner_with_us')</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('/selling#howItWorks') }}">@lang('theme.nav.career')</a>
                                            </li>
                                    ...
                                    <div class="footer__content-box-links">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                @lang('theme.nav.contact_via_email')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('account', 'orders') }}"> @lang('theme.nav.contact_via_chat_support')</a>
