...
return [
     ...
     *
     */
    'title' => config('app.name', 'Heavens9 Sports Nutrition') . ' Installer',
    'next' => 'Next Step',
    'back' => 'Previous',
    'finish' => 'Install',
    'forms' => [
    ...
    'updater' => [
         ...
         *
         */
        'title' => config('app.name', 'Heavens9 Sports Nutrition') . ' Updater',
        ...
        'log' => [
            'success_message' => config('app.name', 'Heavens9 Sports Nutrition') . ' Installer successfully UPDATED on ',
        ],
    ],
];
