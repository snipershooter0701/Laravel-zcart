	        ...
	        <tbody id="massSelectArea">
		        @foreach($categories as $category )
			        <tr>
					  	...
					  	@endcan
			          	<td>
							<img src="{{get_storage_file_url(optional($category->coverImage)->path, public_path('images/no_img.png'))}}" class="img-sm" alt="{{ trans('app.cover_image') }}" style="max-width:50% !important" max-height:"50% !important";>
			          	</td>
			          	<td>
