...
{{ trans('notifications.refund_declined.message', ['order' => $refund->order->order_number, 'amount' => get_formated_currency($refund->amount, true, 2), 'marketplace' => get_platform_title()]) }}
<br/>
